...
class ProviderServicesTabKey extends GlobalKey<_ProviderServicesTabState> {
  const ProviderServicesTabKey() : super.constructor();
}
...
class _ProviderServicesTabState extends State<ProviderServicesTab> {
  ...
  Future<ProviderDetails?>? _futureDetails;
  void showAddServiceForm() => _showServiceForm();
  @override
  void initState() {
    super.initState();
  ...
  void _refresh() {
    if (!mounted) return;
    final user = context.read<AuthProvider>().user; // read OUTSIDE setState
    if (user != null) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    // ✅ No more Stack + Positioned here, just the Column directly
    return Column(
      children: [
        Container(
...
class _ServiceFormModalState extends State<ServiceFormModal> {
  ...
  @override
  Widget build(BuildContext context) {
    // Wrap with Material to provide semantics and theme services
    return Material(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : Text(
                          widget.service == null ? "Ajouter" : "Enregistrer",
                        ),
                ),
              ],
            ),
